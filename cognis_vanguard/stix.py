...
def bundle_from_graph(graph, created: str = DEFAULT_TS) -> dict:
    ...
    return {"type": "bundle", "id": _sid("bundle", "cognis-vanguard:" + created), "objects": objects}
